...
class UrTube:
    ...
    def pegister(self, nickname, password, age):
    ...
    def watch_video(self, film: str, time=None):
    ...
    def register(self, param, param1, param2):
        pass
...
if __name__ == '__main__':
    ...
    ur.register('vasya_pumpkin', 'lolkekcheburek', 13)
    ur.watch_video('Для чего девушкам парень программист?')
